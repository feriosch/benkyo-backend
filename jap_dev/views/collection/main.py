...
from jap_dev.schemas.validation import validate_schema, get_params, get_params_with_image
...
class MainCollectionView(MethodView):
    ...
    # TODO: @validate_schema(collection_insert_schema)
    def post(self):
        return make_response(insert_collection_response(get_params_with_image()))
